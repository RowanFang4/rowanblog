...
module.exports = {
  ...
  POSTS_SHARE_SERVICES:
    //process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,telegram,reddit,whatsapp,linkedinwechat,qq,weibo,email,facebook,twitter,messenger,line', // 分享的服務，按顺序显示,逗号隔开
    process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,email,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
